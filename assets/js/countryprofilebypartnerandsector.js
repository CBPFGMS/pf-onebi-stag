...
const padding = [4, 8, 4, 8],
	...
	thisTab = "Allocations by Partner/Sector",
...
function createCountryProfileByPartnerAndSector(container, lists, colors, tooltipDiv, fundButtons, yearsButtons) {
	...
	//end of createCountryProfileByPartnerAndSector
};
...
export { createCountryProfileByPartnerAndSector };